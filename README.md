...
2+ If you use SSH (secure shell) and want to access other computers in the network, you also need "sshpass".
...
2+. For a 64-bit system, you must also install lrelease: "dnf install qt5-linguist.x86-64"
...
In the basic settings it can be determined whether the reference for setting the password should be displayed or not.
...
1. Choose an existing hard drive/partition in the list on the left to create an image from.
