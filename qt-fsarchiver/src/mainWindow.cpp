...
dateiname = userpath + "/.config/qt-fsarchiver/auftrag.db";  
...
QString attribute;
     ...
     QFile::remove(userpath + "/.config/qt-fsarchiver/zeit.txt");
...
{
QString filename = userpath + "/.config/qt-fsarchiver/auftrag.db";
QFile file(filename);
QString attribute;
QStringList auftrag;
QString auftrag_;  
